...
The aim of this objective is to illustrate the potential difficulties in aligning highly variable sequences, such as those from RNA viruses. I have provided two simulated sequence datasets generated using the program INDELible `r citep(bib["Fletcher2009"])`, for which the true alignment is known.
